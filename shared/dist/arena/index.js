 ...
 */
function rayBoxIntersection(ox, oy, oz, dx, dy, dz, xMin, xMax, yMin, yMax, zMin, zMax, maxT) {
    const eps = 1e-10;
 ...
 */
export function rayArenaIntersection(ox, oy, oz, dx, dy, dz, maxT) {
    let bestT = null;
    for (const [xMin, xMax, zMin, zMax] of ARENA_WALLS) {
        const t = rayBoxIntersection(ox, oy, oz, dx, dy, dz, xMin, xMax, 0, ARENA_WALL_HEIGHT, zMin, zMax, maxT);
